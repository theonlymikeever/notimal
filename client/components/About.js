...
const About = () => {
  return (
    ...
    <div className="col-sm-8">
        ...
        <hr />
      <p>notimal is simple tool to help herbivores on the go decide if they’re able to consume an new food or meal, especially when it’s not explicitly labeled Vegan or Vegetarian friendly.</p>
